...
$WEBservers = 'cis.ccpgames.com', 'lts.ccpgames.com', 'www.eveonline.com', 'login.eveonline.com', 'launcher.eveonline.com'
$WEBport = '443'

$CHATservers = 'tranquility.chat.eveonline.com'
$Chatport = '5222'
...
$traceflow = {
    workflow TestTrace {
        ...
        Foreach -Parallel ($servers in $servers) {
            $result = (Test-NetConnection $servers -TraceRoute -Hops 20).TraceRoute | Select -Skip 3
